...
from SimEngine.Action import WorkerMovementAction, BuildUnitAction, BuildStructureAction, BuildUpgradeAction, Action
...
class TestSimulationEngine(unittest.TestCase):
    ...
    def testLoadStateFromJSON(self):
        ...
        #Now, save off the state in JSON to copmare to later
