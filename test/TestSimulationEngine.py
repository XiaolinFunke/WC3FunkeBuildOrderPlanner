...
def simulateBasicElfBuildOrder(simEngine):
    ...
    actionList1 = []
    actionList1.append(BuildUnitAction(Trigger(TriggerType.ASAP), "Wisp", 60, 0, 1, 14 * SECONDS_TO_SIMTIME, "Tree of Life", False, "Build this wisp fast!"))
    ...
    actionList1.append(BuildUnitAction(Trigger(TriggerType.ASAP), "Demon Hunter", 400, 100, 5, 55 * SECONDS_TO_SIMTIME, "Altar of Elders", True, "Skill mana burn and run to opponent's base"))
    actionList1.append(BuildUpgradeAction(Trigger(TriggerType.LUMBER_AMOUNT, 100), "Strength of the Moon", 125, 75, 60 * SECONDS_TO_SIMTIME, "Hunter's Hall"))

    actionList2 = []
    actionList2.append(BuildUnitAction(Trigger(TriggerType.ASAP), "Wisp", 60, 0, 1, 14 * SECONDS_TO_SIMTIME, "Tree of Life", False, "Build this wisp VERY fast!"))
    ...
    actionList2.append(BuildUnitAction(Trigger(TriggerType.ASAP), "Keeper of the Grove", 400, 100, 5, 55 * SECONDS_TO_SIMTIME, "Altar of Elders", True, "Skill entangle and go with Demon Hunter to opponent's base"))
