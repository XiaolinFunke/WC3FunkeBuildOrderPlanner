...
class TestBuildOrder(unittest.TestCase):
    ...
    def testAddActionToMatchingTimeline(self):
        ...
        action = Action(goldCost=0, lumberCost=0, foodCost=0, travelTime=0, startTime=10, duration=0, requiredTimelineType=TimelineType.ALTAR_OF_ELDERS, events = [], actionName="Test action")
        ...
        badAction = Action(goldCost=0, lumberCost=0, foodCost=0, travelTime=0, startTime=10, duration=0, requiredTimelineType=TimelineType.ANCIENT_OF_LORE, events = [], actionName="Test action")
