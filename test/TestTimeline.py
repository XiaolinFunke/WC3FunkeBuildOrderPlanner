...
from SimEngine.SimulationConstants import Trigger, TriggerType

class TestTimeline(unittest.TestCase):
    def testAddAction(self):
        timeline = Timeline(timelineType=TimelineType.WORKER, timelineID=0, eventHandler=None)

        action = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=10, requiredTimelineType=TimelineType.WORKER)
    ...
    def testAddMultipleActions(self):
        ...
        action2 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=10, requiredTimelineType=TimelineType.WORKER)
    ...
    def testAddOverlappingActions(self):
        ...
        action2 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=5, requiredTimelineType=TimelineType.WORKER)
        ...
        action3 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=4, requiredTimelineType=TimelineType.WORKER)
        ...
        action4 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=6, requiredTimelineType=TimelineType.WORKER)
    ...
    def testFindProperSpotForAction(self):
        ...
        action = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=2, requiredTimelineType=TimelineType.WORKER)
        action.setStartTime(10)
        self.assertEqual(timeline.addAction(action), True)
        ...
        action3 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=1, requiredTimelineType=TimelineType.WORKER)
        ...
        action4 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=1, requiredTimelineType=TimelineType.WORKER)
        ...
        action5 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=1, requiredTimelineType=TimelineType.WORKER)
        ...
        action6 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=5, requiredTimelineType=TimelineType.WORKER)
        ...
        action7 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=3, requiredTimelineType=TimelineType.WORKER)
        action7.setStartTime(11)
        self.assertEqual(timeline.findProperSpotForAction(action7.getStartTime()), 1)

        #Action at end, no overlap
        action8 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=2, requiredTimelineType=TimelineType.WORKER)
        ...
        action9 = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=5, requiredTimelineType=TimelineType.WORKER)
    ...
    def testGetNextAction(self):
        ...
        actionStartTime=10
        action = Action(goldCost=0, lumberCost=0, trigger=Trigger(TriggerType.ASAP), travelTime=0, duration=0, requiredTimelineType=TimelineType.WORKER)
